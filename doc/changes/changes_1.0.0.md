# Artifact Reference Checker and Unifier 1.0.0, released 2026-07-06

Code name: Code Coverage

## Summary

We raised the code coverage to meet Exasol's quality gate for Java projects and updated the version number to 1.0.0 to express the proven stability of this Maven plugin.

## Features

* 33: Raised code coverage to meet quality gate
...
* Updated `com.exasol:error-code-crawler-maven-plugin:1.2.0` to `2.1.0`
* Updated `com.exasol:project-keeper-maven-plugin:5.2.3` to `5.7.2`
